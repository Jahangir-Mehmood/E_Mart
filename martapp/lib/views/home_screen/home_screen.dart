...
import 'package:martapp/views/home_screen/compunents/featured_button.dart';
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: List.generate(
                                ...
                                ).box.margin(EdgeInsets.symmetric(horizontal: 6)).color(whiteColor).padding(EdgeInsets.all(8)).rounded.make(),
                              ),
                            ),
                          )
                        ],
